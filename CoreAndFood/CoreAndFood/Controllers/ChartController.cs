...
namespace CoreAndFood.Controllers
{
    public class ChartController : Controller
    {
        ...
        public IActionResult Statistics()
        {
            ...
            var deger6 = c.Foods.Where(x => x.CategoryID == c.Categories.Where(x=>x.CategoryName=="Legumes").Select(z=>z.CategoryID).FirstOrDefault()).Count();
            ViewBag.d6 = deger6;
            ...
            var deger9 = c.Foods.Sum(x => x.Price).ToString("0.00");
            ViewBag.d9 = deger9;
            ...
            var deger12 = c.Categories.Where(x => x.CategoryName == "Legumes").Select(y => y.CategoryID).FirstOrDefault();
            var deger12p = c.Foods.Where(y => y.CategoryID == deger12).Sum(x => x.Stock);
            ViewBag.d12 = deger12p;
